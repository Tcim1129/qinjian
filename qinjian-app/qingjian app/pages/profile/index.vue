  ...
  <view class="profile-page">
      ...
      <view class="cockpit-card">
        ...
        <view class="action-grid">
          ...
          <view class="action-chip" @click="openReport">
            ...
            <text class="action-copy">回到报告看最新判断</text>
          </view>
    ...
    <view v-if="showPasswordModal" class="modal-wrap">
      ...
      <view class="modal-card">
        ...
        <input v-model="passwordForm.current" class="modal-input" type="password" placeholder="当前密码" />
        <input v-model="passwordForm.next" class="modal-input" type="password" placeholder="新密码（至少 8 位）" />
        <view class="modal-actions">
