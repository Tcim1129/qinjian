(function() {
  ...
  function normalizePrefs(raw = {}) {
    return {
      aiAssistEnabled: (raw == null ? void 0 : raw.ai_assist_enabled) !== false,
      privacyMode: (raw == null ? void 0 : raw.privacy_mode) === "local_first" ? "local_first" : "cloud",
      preferredEntry: ["daily", "emergency", "reflection"].includes(raw == null ? void 0 : raw.preferred_entry) ? raw.preferred_entry : "daily"
    };
  }
  ...
  function determineUploadPolicy(precheck, prefs) {
    ...
    if (((precheck == null ? void 0 : precheck.risk_level) || "none") === "high") {
      return "local_only";
    }
    if ((((_a = precheck == null ? void 0 : precheck.pii_summary) == null ? void 0 : _a.total_hits) || 0) > 0) {
  ...
  class ClientAIService {
    ...
    async init() {
      ...
      try {
        ...
        this._disableWorker((error == null ? void 0 : error.message) || "worker_init_failed");
        return false;
      }
    }
    call(type, payload) {
    ...
    async saveDraft(record) {
      ...
      const draft = {
        ...record,
        id: record.id || (((_b = (_a = window.crypto) == null ? void 0 : _a.randomUUID) == null ? void 0 : _b.call(_a)) || `draft-${Date.now()}`),
