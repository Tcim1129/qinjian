...
def downgrade() -> None:
    op.drop_index("ix_user_interaction_events_occurred_at", table_name="user_interaction_events")
    ...
    op.drop_index("ix_user_interaction_events_event_type", table_name="user_interaction_events")
    op.drop_index("ix_user_interaction_events_source", table_name="user_interaction_events")
    op.drop_index("ix_user_interaction_events_session_id", table_name="user_interaction_events")
